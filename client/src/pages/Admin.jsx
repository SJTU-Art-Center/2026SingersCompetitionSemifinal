                        ...
                        <button
                            onClick={() => {
                                if (gameState.adminRound === 1) {
                                    ...
                                    const revealTick = Number(gameState.round1RevealTick ?? 0) + 1;
                                    updateState({
                                        ...gameState,
                                        screenRound: gameState.adminRound,
                                        currentGroup: adminGroup,
                                        round1Mode: adminRound1Mode,
                                        round1RevealTick: revealTick
                                    });
                                } else if (gameState.adminRound === 1.5) {
                                    const stage = Number(gameState.transitionStage ?? 1);
                                    updateState({ ...gameState, screenRound: 1.5, screenTransitionStage: stage, transitionStage: stage });
